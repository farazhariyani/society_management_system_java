...
public class service_hist_report extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					service_hist_report frame = new service_hist_report();
	 ...
	 * Create the frame.
	 */
	public service_hist_report() {
		setClosable(true);
		setMaximizable(true);
		setTitle("Service Histroy Report");
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
                   /* ExcelExporter exp = new ExcelExporter();
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\shist_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\shist_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					 File file= new File("F:\\DBProjectJan2017\\src\\shist_result.xls");
	...
	for (int i = 0; i < model.getColumnCount(); i++) {
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from SERVICE_HISTORY order by SERVICE_HISTORY_ID";
