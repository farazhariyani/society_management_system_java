...
public class service_report extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					service_report frame = new service_report();
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
                   /* ExcelExporter exp = new ExcelExporter();
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\service_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\service_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					 File file= new File("F:\\DBProjectJan2017\\src\\service_result.xls");
	...
	for (int i = 0; i < model.getColumnCount(); i++) {
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from SERVICE order by SERVICE_ID";
