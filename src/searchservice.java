...
public class searchservice extends JInternalFrame {
	...
	public void fillcombobox2()
	{
		...
		String query="select distinct SERVICE_ID from SERVICE order by SERVICE_ID ";
		PreparedStatement pst=con.prepareStatement(query);
		ResultSet rs=pst.executeQuery();
	...
	public searchservice() throws SQLException{
	  try
	  {
		  setTitle("Service");
			...
			JLabel lblOwner = new JLabel("SERVICE");
		 ...
		 r2 = new JRadioButton("Servicer Id");
				...
				try{
					...
					*/
					...
					//if(rbtnoid.isSelected())
					{
						...
						String q1="select * from SERVICE where SERVICE_ID="+c2.getSelectedItem();
						rs = stmt.executeQuery( q1 );
						//buildTableModel(rs);
						ResultSetMetaData md = rs.getMetaData();
						int columns = md.getColumnCount();
		 ...
		 delete.setIcon(new ImageIcon("F:\\DBProjectJan2017\\src\\delete.png"));
			delete.addActionListener(new ActionListener() {
				...
				try
				{
					...
					String query = "Delete from SERVICE where SERVICE_ID="+value;
