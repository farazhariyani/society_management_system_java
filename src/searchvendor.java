...
public class searchvendor extends JInternalFrame {
	...
	public void fillcombobox2()
	{
		...
		String query="select distinct VENDOR_ID from VENDOR order by VENDOR_ID ";
		PreparedStatement pst=con.prepareStatement(query);
		ResultSet rs=pst.executeQuery();
	...
	public searchvendor() throws SQLException{
	  try
	  {
		  setTitle("Vendor");
			...
			JLabel lblOwner = new JLabel("VENDOR");
				...
				try{
					...
					*/
					...
					//if(rbtnoid.isSelected())
					{
						...
						String q1="select * from VENDOR where VENDOR_ID="+c2.getSelectedItem();
						rs = stmt.executeQuery( q1 );
						//buildTableModel(rs);
						ResultSetMetaData md = rs.getMetaData();
						int columns = md.getColumnCount();
		 ...
		 delete.setIcon(new ImageIcon("F:\\DBProjectJan2017\\src\\delete.png"));
			delete.addActionListener(new ActionListener() {
				...
				try
				{
					...
					String query = "Delete from VENDOR where VENDOR_ID="+value;
