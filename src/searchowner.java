...
public class searchowner extends JInternalFrame {
	...
	public void fillcombobox()
	{
		...
		String query="select * from OWNER order by OWNER_ID ";
	...
	public void fillcombobox2()
	{
		...
		String query="select distinct OWNER_ID from OWNER order by OWNER_ID ";
		PreparedStatement pst=con.prepareStatement(query);
		ResultSet rs=pst.executeQuery();
		...
		{	
			...
			c2.addItem(rs.getString("OWNER_ID"));
		}
		con.close();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
	 ...
	 * Create the frame.
	 */
	public searchowner() throws SQLException{
	  try
	  {
		  setTitle("Owner");
			//setMaximum(true);
				...
				try{
					...
					*/
					...
					//if(rbtnoid.isSelected())
					{
						...
						String q1="select * from OWNER where OWNER_ID="+c2.getSelectedItem();
						rs = stmt.executeQuery( q1 );
						//buildTableModel(rs);
						ResultSetMetaData md = rs.getMetaData();
						int columns = md.getColumnCount();
		 ...
		 delete.setIcon(new ImageIcon("F:\\DBProjectJan2017\\src\\delete.png"));
			delete.addActionListener(new ActionListener() {
				...
				try
				{
					...
					String query = "Delete from OWNER where OWNER_ID="+value;
			...
			update.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					main_owner so=new main_owner(value);
