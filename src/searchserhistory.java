...
public class searchserhistory extends JInternalFrame {
	...
	public void fillcombobox()
	{
		...
		String query="select * from SERVICE_HISTORY order by FLAT_ROWHOUSE_NO ";
	...
	public void fillcombobox2()
	{
		...
		String query="select distinct SERVICE_ID from SERVICE_HISTORY order by SERVICE_ID ";
		PreparedStatement pst=con.prepareStatement(query);
		ResultSet rs=pst.executeQuery();
		...
		{	
			...
			c2.addItem(rs.getString("SERVICE_ID"));
		}
		con.close();
		} catch (SQLException e) {
			// TODO Auto-generated catch block
	 ...
	 * Create the frame.
	 */
	public searchserhistory() throws SQLException{
	  try
	  {
		  setTitle("Service History");
			...
			JLabel lblOwner = new JLabel("SERVICE HISTORY");
			lblOwner.setFont(new Font("Times New Roman", Font.BOLD, 20));
			lblOwner.setBounds(285, 11, 228, 24);
		 ...
		 r2 = new JRadioButton("Service Id");
				...
				try{
					...
					*/
					...
					//if(rbtnoid.isSelected())
					{
						...
						String q1="select * from SERVICE_HISTORY where SERVICE_ID="+c2.getSelectedItem();
						rs = stmt.executeQuery( q1 );
						//buildTableModel(rs);
						ResultSetMetaData md = rs.getMetaData();
						int columns = md.getColumnCount();
		...
		Search.setBounds(483, 87, 144, 33);
		 ...
		 delete.setIcon(new ImageIcon("F:\\DBProjectJan2017\\src\\delete.png"));
			delete.addActionListener(new ActionListener() {
				...
				try
				{
					...
					String query = "Delete from SERVICE_HISTORY where SERVICE_ID="+value;
			...
			update.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					servicehistory so=new servicehistory(value);
