...
public class fmem_reports extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fmem_reports frame = new fmem_reports();
	...
	public fmem_reports() {
		...
		mntmExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\fmem_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\fmem_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					
		               File file= new File("F:\\DBProjectJan2017\\src\\fmem_result.xls");
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from FLAT_MEMBER order by FLAT_ROWHOUSE_NO";
