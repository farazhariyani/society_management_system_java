...
public class Flat_Reports extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Flat_Reports frame = new Flat_Reports();
	...
	public Flat_Reports() {
		...
		mntmExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
               ...
               File file= new File("F:\\DBProjectJan2017\\src\\flt_result.xls");
...
for (int i = 0; i < model.getColumnCount(); i++) {
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from FLAT order by FLAT_ROWHOUSE_NO";
