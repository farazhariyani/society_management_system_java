...
public class searchflat extends JInternalFrame {
	...
	public void fillcombobox2()
	{
		...
		String query="select distinct OWNER_ID from FLAT order by OWNER_ID ";
		PreparedStatement pst=con.prepareStatement(query);
		ResultSet rs=pst.executeQuery();
	 ...
	 * Create the frame.
	 */
	public searchflat() throws SQLException{
	  try
	  {
		  setTitle("Flat");
			//setMaximum(true);
			...
			JLabel lblOwner = new JLabel("FLAT");
				...
				try{
					...
					*/
					...
					//if(rbtnoid.isSelected())
					{
						...
						String q1="select * from FLAT where OWNER_ID="+c2.getSelectedItem();
						rs = stmt.executeQuery( q1 );
						//buildTableModel(rs);
						ResultSetMetaData md = rs.getMetaData();
						int columns = md.getColumnCount();
		 ...
		 delete.setIcon(new ImageIcon("F:\\DBProjectJan2017\\src\\delete.png"));
			delete.addActionListener(new ActionListener() {
				...
				try
				{
					...
					String query = "Delete from FLAT where OWNER_ID="+value;
