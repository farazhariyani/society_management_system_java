...
public class ftransfer_report extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ftransfer_report frame = new ftransfer_report();
	 ...
	 * Create the frame.
	 */
	public ftransfer_report() {
		setClosable(true);
		setMaximizable(true);
		setTitle("Flat Transfer Report");
		...
		mntmExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\ftrans_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\fmem_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					
		               File file= new File("F:\\DBProjectJan2017\\src\\ftrans_result.xls");
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from TRANSFER order by TRANSFER_ID";
