...
public class owner_report extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					owner_report frame = new owner_report();
		...
		mntmExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\own_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\own_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					 File file= new File("F:\\DBProjectJan2017\\src\\own_result.xls");
	...
	for (int i = 0; i < model.getColumnCount(); i++) {
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from OWNER order by OWNER_ID";
