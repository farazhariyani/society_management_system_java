...
public class receipt_reports extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					receipt_reports frame = new receipt_reports();
	 ...
	 * Create the frame.
	 */
	public receipt_reports() {
		setClosable(true);
		setMaximizable(true);
		setTitle("Receipt Report");
		...
		mntmExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\receipt_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\receipt_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					 File file= new File("F:\\DBProjectJan2017\\src\\receipt_result.xls");
	...
	for (int i = 0; i < model.getColumnCount(); i++) {
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from RECEIPT order by RECEIPT_ID";
