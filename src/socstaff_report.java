...
public class socstaff_report extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					socstaff_report frame = new socstaff_report();
		...
		mntmExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
                    ...
                    exp.fillData(table, new File("F:\\DBProjectJan2017\\src\\staff_result.xls"));
                    JOptionPane.showMessageDialog(null, "Data saved at " +
                            "'F:\\DBProjectJan2017\\src\\staff_result.xls' successfully", "Message",
                            JOptionPane.INFORMATION_MESSAGE);*/
					
					 File file= new File("F:\\DBProjectJan2017\\src\\staff_result.xls");
	...
	for (int i = 0; i < model.getColumnCount(); i++) {
		...
		try{
			...
			//data.clear();
				...
				String q1="select * from SOCIETY_STAFF order by STAFF_ID";
