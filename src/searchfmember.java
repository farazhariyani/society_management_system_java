...
public class searchfmember extends JInternalFrame {
	...
	public void fillcombobox()
	{
		...
		String query="select distinct FLAT_ROWHOUSE_NO from FLAT_MEMBER order by FLAT_ROWHOUSE_NO ";
	 ...
	 * Create the frame.
	 */
	public searchfmember () throws SQLException{
	  try
	  {
		  setTitle("Flat Member");
			...
			JLabel lblOwner = new JLabel("FLAT MEMBER");
			lblOwner.setFont(new Font("Times New Roman", Font.BOLD, 20));
			lblOwner.setBounds(285, 11, 191, 24);
				...
				try{
					...
					*/
					...
					//if(rbtnoid.isSelected())
					{
						...
						String q1="select * from FLAT_MEMBER where FLAT_ROWHOUSE_NO="+c2.getSelectedItem();
						rs = stmt.executeQuery( q1 );
						//buildTableModel(rs);
						ResultSetMetaData md = rs.getMetaData();
						int columns = md.getColumnCount();
		 ...
		 delete.setIcon(new ImageIcon("F:\\DBProjectJan2017\\src\\delete.png"));
			delete.addActionListener(new ActionListener() {
				...
				try
				{
					...
					String query = "Delete from FLAT_MEMBER where FLAT_ROWHOUSE_NO="+value;
			...
			update.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					flatmember so=new flatmember(value);
